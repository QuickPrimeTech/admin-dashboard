    ...
    <div className="flex items-center justify-center min-h-[60vh] px-4 mt-8">
      <Card className="w-full max-w-md text-center shadow-xl">
        ...
        <CardContent>
          ...
          <Link
            href={whatsappLink}
            className="inline-block bg-linear-to-r from-primary to-primary/60 hover:from-primary/90 hover:to-primary/90 text-white px-5 py-3 rounded-lg font-medium transition-all duration-300 shadow-lg hover:shadow-xl"
          >
